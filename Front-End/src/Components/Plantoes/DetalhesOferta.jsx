                ...
                <section className="top-section">
                    <div className="details-card">
                        ...
                        <div className="general-info">
                            ...
                            <p>
                                Plantão em UTI de alta
                                complexidade. O profissional será
                                responsável pela evolução diária,
                                procedimentos invasivos necessários e
                                interface com as equipes de apoio.
