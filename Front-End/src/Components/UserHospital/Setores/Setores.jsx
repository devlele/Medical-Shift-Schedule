...
export default function Setores() {
    ...
    const carregarDados = async () => {
        try {
            ...
            const [setoresData, doctorsData] =
                await Promise.all([
                    getSetores(),
                    getDoctors(),
                ]);

            const setoresComMedicos =
    ...
    const totalPages = Math.ceil(
        setoresFiltrados.length / ITEMS_PER_PAGE
    );

    const setoresPaginados =
                ...
                <div className="modal-overlay">
                    <div className="novo-setor-modal">
                        ...
                        <p className="modal-subtitle">
                            Defina as configurações básicas da
                            unidade.
                        </p>
